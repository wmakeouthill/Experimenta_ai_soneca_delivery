...
public class Motoboy extends BaseEntity {
     ...
     */
    public static Motoboy restaurarDoBanco(String id, String nome, String telefone, String veiculo, String placa, boolean ativo, 
                                            LocalDateTime createdAt, LocalDateTime updatedAt) {
        Motoboy motoboy = new Motoboy();
        motoboy.restaurarId(id);
        motoboy.nome = nome;
        motoboy.telefone = telefone;
        motoboy.veiculo = veiculo;
        motoboy.placa = placa;
        motoboy.ativo = ativo;
        motoboy.restaurarTimestamps(createdAt, updatedAt);
        return motoboy;
    }
