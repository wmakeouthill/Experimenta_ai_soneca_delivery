...
--changeset soneca-delivery:044-1
--comment: Criar tabela de pedidos delivery com idempotência
...
--changeset soneca-delivery:044-2
--comment: Criar tabela de itens do pedido delivery
--preconditions onFail:MARK_RAN
...
--changeset soneca-delivery:044-3
--comment: Criar tabela de adicionais dos itens do pedido delivery
--preconditions onFail:MARK_RAN
...
--changeset soneca-delivery:044-4
--comment: Criar sequence para número de pedido delivery
--preconditions onFail:MARK_RAN
...
--changeset soneca-delivery:044-5
--comment: Criar tabela de meios de pagamento do pedido delivery
--preconditions onFail:MARK_RAN
