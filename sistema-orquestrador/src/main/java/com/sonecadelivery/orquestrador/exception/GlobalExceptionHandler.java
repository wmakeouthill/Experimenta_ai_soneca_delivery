...
public class GlobalExceptionHandler {
    ...
    /**
     * Trata exceções de I/O relacionadas a conexões fechadas (broken pipe,
     * connection reset, etc.).
     * Essas exceções são esperadas quando clientes desconectam durante SSE ou
     * streaming.
     * Não devem ser logadas como erro, pois são comportamento normal.
     * 
     * Nota: SocketException é uma subclasse de IOException, então será capturada
     * automaticamente.
     */
    ...
    /**
     * Trata exceções quando recursos estáticos não são encontrados (ex:
     * index.html).
